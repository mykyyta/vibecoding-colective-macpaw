...
import { PERSONAS_DISPLAY } from "./personas-display";
import type { BrowserSpeechSettings, BubbleActor } from "./personas-display";
import type {
...
function getBubbleForVoiceTurn(
  ...
  const persona = PERSONAS_DISPLAY[actor];

  return {
    actor: persona.bubbleActor,
    name: persona.getDisplayName(questState, language),
    text: reply,
  };
}
...
function getBrowserSpeechSettings(actor: QuestActor): BrowserSpeechSettings {
  return PERSONAS_DISPLAY[actor].browserSpeech;
}
