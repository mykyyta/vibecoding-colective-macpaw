  ...
  "sofia-introduced": {
    ...
    describe: () =>
      [
        ...
        "greets, introduces herself and Dan, mentions that the event has ended",
        "and the door is locked, and softly nudges the player to start with",
        "Dan. Keep the intro light and welcoming — do NOT yet mention the",
        "badge, the code, or anything specific about how to get out. Let the",
        "player discover those details by engaging Dan. Actor must be Sofiia.",
        "nameTagActors must include sofia and dan.",
      ].join(" "),
